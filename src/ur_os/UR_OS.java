...
public class UR_OS {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("3. Sequential Pattern Generator in Python");
        System.out.println("4. initSimulationQueueSimpler4");
        System.out.println("5. initSimulationPage1NotFrequent");
        System.out.println("6. Random Pattern Generator in Python");
        System.out.println("7. Fixed pattern generator in Python");
