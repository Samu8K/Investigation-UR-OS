...
public class OS {
    ...
    public ProcessVirtualMemoryManagerType pvmm;
    public static final int MAX_PROCESS_PRIORITY = 10; //Page size in bytes
    public static final int MAX_PROC_SIZE = 1024; // o el valor que prefieras
    public static int PAGE_SIZE = 32*1024; //Page size in bytes
    ...
    public static int FRAMES_PER_PROCESS = 2;
    ...
    public OS(SystemOS system, CPU cpu, IOQueue ioq, ProcessVirtualMemoryManagerType pvmm) {
    ...
    public void interrupt(InterruptType t, Process p, Object i){
        ...
        switch(t){
            ...
            case FINISH_PROCESS:
                ...
                System.out.println(p);  // <--- Agrega esto
                fmm.reclaimMemory(p);
    ...
    public void create_process(ur_os.process.Process p){
        ...
        switch(pvmm){//Assign the Process Virtual Memory Manager, to support the selection of the victim memory division
            ...
            case LRFU:
                p.getPMM().setPVMM(new PVMM_LRFU());
                break;
            case SCLFU:
                p.getPMM().setPVMM(new PVMM_SCLFU());
                break;
